...
Copy-paste templates untuk berbagai jenis dokumentasi. Replace placeholder `[...]` dengan content yang sesuai.
...
|
| Dependencies:
| - [Dependency 1] untuk [purpose]
| - [Dependency 2] untuk [purpose]
|
*/
class [ServiceName]
{
...
class [ModelName] extends Model
{
    ...
    */
    ...
    /**
     * [Accessor description dengan formula jika ada]
     */
...
class [ControllerName] extends Controller
{
     ...
     *
     * @param [Model] $[model] [Description dengan route model binding]
     */
